...
let points = [
  [6, 5], [-3, 16], [-5, 8], [-2, 1], [-6, 3], [-4, -6], [-5, -6], [3, -4],
  [6, -3], [5, -1], [5, 2], [11, 3], [12, 3], [15, 4], [5, 4], [3, 2],
  [2, 5], [3, 6.2], [0, 4], [-3, 12], [-3, 7.5], [8, 3]]
var fill_colors = "8ecae6-219ebc-023047-ffb703-fb8500".split("-").map(a=>"#"+a)
var line_colors = "8ecae6-219ebc-023047-ffb703-fb8500".split("-").map(a=>"#"+a)
